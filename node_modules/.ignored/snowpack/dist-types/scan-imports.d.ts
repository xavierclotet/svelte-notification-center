...
export declare function scanImports(cwd: string, config: SnowpackConfig): Promise<InstallTarget[]>;
export declare function scanImportsFromFiles(loadedFiles: SnowpackSourceFile[], { scripts }: SnowpackConfig): Promise<InstallTarget[]>;
